...
export const failedWriteResultDescriptionTemplateProviderEnUs: FailedWriteResultDescriptionTemplateProvider =
  {
    ...
    [InvalidInstructionReason.RepeatInstructionWithInvalidTargets]:
      'Failed to write the given target instructions to the tab',
